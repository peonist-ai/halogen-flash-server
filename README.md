...
podman run --rm -p 8731:8731 \
  ...
  ghcr.io/peonist-ai/halogen-flash-server:0.5.4
```
...
```bash
podman run ... ghcr.io/peonist-ai/halogen-flash-server:0.5.4 bench serial,mtp 256 low 3
podman run ... ghcr.io/peonist-ai/halogen-flash-server:0.5.4 sweep -p 8192,32768 -n 128
```
